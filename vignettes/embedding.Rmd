...
```{r, fig.show='hold'}
EmbedSOM::PlotEmbed(e, data=data, pch=16, cex=.5, alpha=0.3, value=1)
```
...
Or multiple markers:
```{r, fig.show='hold'}
EmbedSOM::PlotEmbed(e, data=data, pch=16, cex=.5, alpha=0.3, red=2, green=4)
```
...
EmbedSOM::PlotEmbed(e, pch=16, cex=.5, clust=metaclusters, alpha=.3)
```
